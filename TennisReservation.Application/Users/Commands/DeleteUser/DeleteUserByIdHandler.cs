...
namespace TennisReservation.Application.Users.Commands.DeleteUser
{
    public class DeleteUserByIdHandler
    {
        private readonly IUsersRepository _usersRepository;
        private readonly ILogger<DeleteUserByIdHandler> _logger;
        public DeleteUserByIdHandler(IUsersRepository usersRepository, ILogger<DeleteUserByIdHandler> logger)
        {
